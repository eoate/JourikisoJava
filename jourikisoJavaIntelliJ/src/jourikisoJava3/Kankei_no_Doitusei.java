...
public class Kankei_no_Doitusei {
    //A,Bについて関係>と>=が等しいかどうか判定する関数を実装する
    public static boolean AB(Set<Integer> numbersA, Set<Integer> numbersB){
    ...
    public static void main(String[] args) {
        System.out.println(AB(Set.of(1,3,5,6),Set.of(2,4,7,8))); //出力:true
        System.out.println(AB(Set.of(1,2,3,4),Set.of(3,4,5,6))); //出力:false
    }
}
